...
■ >> Essam 
~~~~
■ >> [𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒓𝒖𝒄𝒆](http://t.me/MX34XM)

■ >> [𝑻𝒂𝒘𝒔𝒍 𝒔𝒐𝒓𝒖𝒄𝒆](http://t.me/N2KOBOT)

■ >> [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝒔𝒐𝒓𝒖𝒄𝒆](http://t.me/gh_gh90)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_,"🗑┋ حساب المنظف محذوف")
return false  
end
...
if text ==("رفع المنظف") and Sudo(msg) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
send(msg.chat_id_, msg.id_,"👮‍♂️┋تم ترقية منظف المجموعه : ["..b.first_name_.."](T.me/"..UserName..")")  
...
if text and text:match("^تنزيل منظف$") and msg.reply_to_message_id_ and BasicConstructor(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text and text == ".................. يننسنشسطسمشكضجؤكميكشكشك") then 
send(msg.chat_id_, msg.id_, '🚫¦ تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "مسنؤنسكشددسجصحضح٨٢٨٨٣٧ق٧بهؤننس٨٢٧ثهرن") then 
